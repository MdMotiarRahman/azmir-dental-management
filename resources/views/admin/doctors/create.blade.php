...
<div class="mb-6 md:mb-8">
    ...
    <h1 class="text-xl md:text-2xl font-bold text-gray-900">Add New Doctor</h1>
</div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div class="sm:col-span-2">
                        ...
                        <input type="text" name="name" id="name" value="{{ old('name') }}"
                            ...
                            placeholder="e.g. Dr. Sher Shah" required>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <div class="flex justify-between items-center mt-1.5">
                            ...
                            <span class="text-xs text-gray-400 ml-auto"><span id="bio-count">0</span>/1000</span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="space-y-4 md:space-y-6">
            ...
            <div class="bg-white rounded-xl shadow-sm p-4 md:p-6">
                ...
                <div class="flex flex-col items-center">
                    <div id="photo-preview" class="w-32 h-32 rounded-xl overflow-hidden bg-gray-100 flex items-center justify-center border-2 border-dashed border-gray-300 mb-4">
            ...
            <div class="bg-white rounded-xl shadow-sm p-4 md:p-6">
                <h2 class="text-base font-semibold text-gray-900 mb-4 flex items-center gap-2">
                    <i class="fas fa-save text-primary-500"></i> Save
                </h2>
                <div class="space-y-3">
